                                ...
                                <ul className="bg-white absolute top-6 left-0 min-w-[250px] px-1 py-1 text-black shadow-lg">
                                    {
                                        subMenuData.map((submenu)=>{
                                            return(
                                                ...
                                                <li className="h-12 flex justify-between items-center hover:text-black/40 rounded-md">{submenu.name}
                                                <span className="opacity-50 text-sm">{submenu.doc_count}</span></li>
